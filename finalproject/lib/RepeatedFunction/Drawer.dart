...
import 'package:finalproject/HomePage/HomePage.dart';
import 'package:finalproject/SectionHomeUi/FavoriateList.dart';
      ...
      child: Container(
        ...
        child: ListView(
          children: [
            ...
            listtilefunc('My channel youtube', FontAwesomeIcons.youtube,
                ontap: () async {
              var url =
                  'https://youtube.com/@hartativiriyas9768?si=6QM6KDWQYNFhlKQP';
              await launch(url);
            }),
            listtilefunc('About', Icons.info, ontap: () {
              showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      backgroundColor: Color.fromRGBO(18, 18, 18, 0.9),
                      title: overviewtext('this is my final project :)'),
                      actions: [
                        TextButton(
                            onPressed: () {
                              Navigator.pop(context);
